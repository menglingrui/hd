 ...
 * @throws Exception 
  */
  public void onBoSave(ReportVO1[] vos,String prid ,String sdate ,String ddate) throws Exception{
	  ...
	  String sql=" update hd_rept1 set dr=1 where "+wsql;
  ...
  */
  public Integer  valute(String prid ,String sdate ,String ddate) throws  Exception{
	  ...
	  String sql=" select count(0) from hd_rept1  where"+wsql;
  ...
  //sqhl->iif(sdate==null || sdate==" ",
  //getColValue2(bd_currrate,rate,pk_currinfo,pk_currtype1,ratedate,begindate),
  //getColValue2(bd_currrate,rate,pk_currinfo,pk_currtype1,ratedate,sdate) );
 // String sql=" select rate from bd_currrate where pk_currtype1=? and ratedate=? and isnull(dr,0)=0";
