	...
	*/
	public String[] getField() {
		return new String[] {			
			...
			"H_coperatorid->SYSOPERATOR",//操作员
			"H_cwhsmanagerid->H_cwhsmanagerid",//库管员ID
			"H_vnote->H_vnote",//备注
			...
			"H_cwarehouseid->H_cinwarehouseid",//仓库ID
			"H_pk_calbody->H_pk_calbody",//库存组织
			"H_dbilldate->SYSDATE",//单据日期
			"H_cbizid->H_cinbizid",//业务员ID
			"H_cdptid->H_cindptid",//部门ID
			...
			"B_cfirstbillhid->B_cfirstbillhid",//保留源头单据
			"B_cfirstbillbid->B_cfirstbillbid",//保留源头单据
			"B_vfirstbillcode->B_vfirstbillcode",//保留源头单据
			"B_cfirsttype->B_cfirsttype",//保留源头单据
			...
			"B_ntarenum->B_ntarenum",//皮重主数量
//			"B_pk_bodycalbody->H_pk_defdoc1",//库存组织
//			"B_pk_corp->H_pk_defdoc2",//表体公司
			//
			"B_nshouldinnum->B_nshouldoutnum", //应入数量 
			"B_nneedinassistnum->B_nshouldoutassistnum",// 应入辅数量
			//
			"B_ninnum->B_noutnum",// 实入数量  modify by yf 出库推入库的时候需要实际数量
//			"B_ninassistnum->B_noutassistnum",// 实入辅数量
//			
//			"B_ncorrespondnum->B_noutnum",//累计入库数量
			 //
		};
	}
	/**
...
//				"B_noutnum->B_ninnum - iif(B_ncorrespondnum==null,0,B_ncorrespondnum)",//累计出库数量
//				"B_noutassistnum->B_ninassistnum-iif(B_ncorrespondastnum==null,0,B_ncorrespondastnum)",//累计出库辅数量
//				"B_noutgrossnum->B_ningrossnum-iif(B_ncorrespondgrsnum==null,0,B_ncorrespondgrsnum)",//累计出库毛重
//				"B_nmny->B_nprice*(B_ninnum - iif(B_ncorrespondnum==null,0,B_ncorrespondnum))",//累计出库数量
